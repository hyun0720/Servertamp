...
public class PandorothyNfcServer extends Activity implements NfcAdapter.CreateNdefMessageCallback, NfcAdapter.OnNdefPushCompleteCallback {
    ...
    public NdefMessage createNdefMessage(NfcEvent event) {
        ...
        NdefMessage message = new NdefMessage( new NdefRecord[] {
                createTextRecord("pandorothy", Locale.ENGLISH)
        });
        return message;
    }
