...
public class GaeunMainActivity extends AppCompatActivity {
    TextView mTextView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent_act = new Intent(getApplicationContext(), GaeunPhoneServer.class);
        ...
        button2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = getIntent();
                Intent intent_act = new Intent(getApplicationContext(), GaeunNfcServer.class);
                startActivity(intent_act);
            }
        ...
        button3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = getIntent();
                Intent intent_act = new Intent(getApplicationContext(), GaeunPhoneCouponUse.class);
                startActivity(intent_act);
            }
    ...
    public void showMsg(NdefMessage mMessage) {
        ...
        for (int i = 0; i < recs.length; i++) {
            ...
            //NFC로 쿠폰 쓸 때, 카페이름으로 구분해서 디비에 stamps 갯수 빼기
                    ...
                    Response.Listener<String> responseListener = new Response.Listener<String>() {
                        public void onResponse(String response) {
                            try {
                                ...
                                if (success) {
                                    Toast.makeText(GaeunMainActivity.this, "쿠폰을 사용했습니다!", Toast.LENGTH_SHORT).show();

                                    Intent intent = new Intent(getApplicationContext(), GaeunMainActivity.class);
                                    intent.putExtra("phonenumber", phonenumber);
                                    intent.putExtra("stamps", stamps);

                                } else {
                                    Toast.makeText(GaeunMainActivity.this, "쿠폰 사용에 실패했습니다 ㅠㅠ ", Toast.LENGTH_SHORT).show();
                    ...
                    GaeunStampUseRequest gaeunStampUseRequest = new GaeunStampUseRequest(phonenumber, stamps + "", responseListener);
                    RequestQueue queue = Volley.newRequestQueue(GaeunMainActivity.this);
                    queue.add(gaeunStampUseRequest);
            }
        }
