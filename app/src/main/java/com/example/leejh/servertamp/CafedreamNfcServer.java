...
public class CafedreamNfcServer extends Activity implements NfcAdapter.CreateNdefMessageCallback, NfcAdapter.OnNdefPushCompleteCallback {
    ...
    public NdefMessage createNdefMessage(NfcEvent event) {
        ...
        NdefMessage message = new NdefMessage( new NdefRecord[] {
                createTextRecord("cafedream", Locale.ENGLISH)
        });
        return message;
    }
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case 1:
                    mTextView.setText("쿠폰 전송 완료!");//NDEF message sending completed
                    break;
            }
        }
    };
