...
/**
 * Created by Lee jh on 2017-11-18.
 */

public class NfcScanner2 extends Activity {
    TextView mTextView;
    Button use;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nfc_scanner2);

        mTextView = (TextView)findViewById(R.id.textMessage);
        use=(Button)findViewById(R.id.usecoupon);
        // NFC 어댑터를 구한다
        ...
        use.findViewById(R.id.usecoupon);
    ...
    public void showMsg(NdefMessage mMessage) {
        ...
        for (int i = 0; i < recs.length; i++) {
            ...
            strMsg += (strRec);
            mTextView.append(strRec);
        }
    }

    // 버퍼 데이터를 디코딩해서 String 으로 변환   => 이미지로 변환하고 싶음!!!!!!
