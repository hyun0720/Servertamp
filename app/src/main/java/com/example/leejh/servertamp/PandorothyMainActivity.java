...
public class PandorothyMainActivity extends AppCompatActivity {
    TextView mTextView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent_act = new Intent(getApplicationContext(), PandorothyPhoneServer.class);
        ...
        button2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = getIntent();
                Intent intent_act = new Intent(getApplicationContext(), PandorothyNfcServer.class);
                startActivity(intent_act);
            }
        ...
        button3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = getIntent();
                Intent intent_act = new Intent(getApplicationContext(), PandorothyPhoneCouponUse.class);
                startActivity(intent_act);
            }
    ...
    public void showMsg(NdefMessage mMessage) {
        ...
        for (int i = 0; i < recs.length; i++) {
            ...
            // NDEF 메시지를 화면에 출력
            final String phonenumber = mTextView.getText().toString();
            ...
            Response.Listener<String> responseListener = new Response.Listener<String>() {
                public void onResponse(String response) {
                    try {
                        ...
                        if (success) {
                            Toast.makeText(PandorothyMainActivity.this, "쿠폰을 사용했습니다!", Toast.LENGTH_SHORT).show();

                            Intent intent = new Intent(getApplicationContext(), PandorothyMainActivity.class);
                            intent.putExtra("phonenumber", phonenumber);
                            intent.putExtra("stamps", stamps);

                        } else {
                            Toast.makeText(PandorothyMainActivity.this, "쿠폰 사용에 실패했습니다 ㅠㅠ ", Toast.LENGTH_SHORT).show();
            ...
            PandorothyStampUseRequest pandorothyStampUseRequest = new PandorothyStampUseRequest(phonenumber, stamps + "", responseListener);
            RequestQueue queue = Volley.newRequestQueue(PandorothyMainActivity.this);
            queue.add(pandorothyStampUseRequest);
        }
    }
