...
public class CafedreamPhoneCouponUse extends Activity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.getNumber:
                ...
                Response.Listener<String> responseListener = new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (success) {
                                Toast.makeText(CafedreamPhoneCouponUse.this, "쿠폰을 사용했습니다.", Toast.LENGTH_SHORT).show();

                                Intent intent = new Intent(getApplicationContext(), GaeunPhoneServer.class);
                                intent.putExtra("phonenumber", phonenumber);
                                intent.putExtra("stamps", stamps);
                            } else {
                                Toast.makeText(CafedreamPhoneCouponUse.this, "쿠폰 사용에 실패했습니다. ", Toast.LENGTH_SHORT).show();
                            }
                ...
                CafedreamStampUseRequest cafedreamStampUseRequest = new CafedreamStampUseRequest(phonenumber, stamps +"" ,responseListener);
                RequestQueue queue = Volley.newRequestQueue(CafedreamPhoneCouponUse.this);
