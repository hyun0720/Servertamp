...
public class CafedreamPhoneServer extends Activity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.getNumber:
                ...
                Response.Listener<String> responseListener = new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (success) {
                                Toast.makeText(CafedreamPhoneServer.this, "쿠폰 등록에 성공했습니다.", Toast.LENGTH_SHORT).show();

                                Intent intent = new Intent(getApplicationContext(), GaeunPhoneServer.class);
                                intent.putExtra("phonenumber", phonenumber);
                                intent.putExtra("stamps", stamps);
                            } else {
                                Toast.makeText(CafedreamPhoneServer.this, "쿠폰 등록에 실패했습니다. ", Toast.LENGTH_SHORT).show();
                            }
                ...
                CafedreamStampRequest cafedreamStampRequest = new CafedreamStampRequest(phonenumber, stamps +"" ,responseListener);
                RequestQueue queue = Volley.newRequestQueue(CafedreamPhoneServer.this);
                queue.add(cafedreamStampRequest);
        }
    }
}
