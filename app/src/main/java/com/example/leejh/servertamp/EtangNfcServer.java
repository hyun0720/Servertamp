...
public class EtangNfcServer extends Activity implements NfcAdapter.CreateNdefMessageCallback, NfcAdapter.OnNdefPushCompleteCallback {
    ...
    public NdefMessage createNdefMessage(NfcEvent event) {
        ...
        NdefMessage message = new NdefMessage( new NdefRecord[] {
                createTextRecord("etang", Locale.ENGLISH)
        });
        return message;
    }
