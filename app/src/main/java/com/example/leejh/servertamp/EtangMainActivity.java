...
public class EtangMainActivity extends AppCompatActivity {
    TextView mTextView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent_act = new Intent(getApplicationContext(), EtangPhoneServer.class);
        ...
        button2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = getIntent();
                Intent intent_act = new Intent(getApplicationContext(), EtangNfcServer.class);
                startActivity(intent_act);
            }
        ...
        button3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = getIntent();
                Intent intent_act = new Intent(getApplicationContext(), EtangPhoneCouponUse.class);
                startActivity(intent_act);
            }
    ...
    public void showMsg(NdefMessage mMessage) {
        ...
        for (int i = 0; i < recs.length; i++) {
            ...
            Response.Listener<String> responseListener = new Response.Listener<String>() {
                public void onResponse(String response) {
                    try {
                        ...
                        if (success) {
                            Toast.makeText(EtangMainActivity.this, "쿠폰을 사용했습니다!", Toast.LENGTH_SHORT).show();

                            Intent intent = new Intent(getApplicationContext(), EtangMainActivity.class);
                            intent.putExtra("phonenumber", phonenumber);
                            intent.putExtra("stamps", stamps);

                        } else {
                            Toast.makeText(EtangMainActivity.this, "쿠폰 사용에 실패했습니다 ㅠㅠ ", Toast.LENGTH_SHORT).show();
            ...
            EtangStampUseRequest etangStampUseRequest = new EtangStampUseRequest(phonenumber, stamps + "", responseListener);
            RequestQueue queue = Volley.newRequestQueue(EtangMainActivity.this);
            queue.add(etangStampUseRequest);
        }
    }
